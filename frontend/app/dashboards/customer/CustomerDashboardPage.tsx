...
import HomePage from "@/components/Customer_Dashboard/HomePage";
import ServicesPage from "@/components/Customer_Dashboard/ServicesPage";
import AppointmentsPage from "@/components/Customer_Dashboard/AppointmentsPage";
import MyAppointmentsPage from "@/components/Customer_Dashboard/MyAppointmentsPage";
import PaymentsPage from "@/components/Customer_Dashboard/PaymentsPage";
import ProfilePage from "@/components/Customer_Dashboard/ProfilePage";
...
const CustomerDashboardPage = () => {
  ...
  const handleLogout = async () => {
    const result = await Swal.fire({
      title: "Leave so soon?",
      text: "Your salon experience awaits! Are you sure you want to logout?",
      icon: "question",
  ...
  const navItems = [
    ...
    { icon: Heart, label: "My Appointments", tab: "my_appointments" },
    { icon: Coins, label: "Payments", tab: "payments" },
